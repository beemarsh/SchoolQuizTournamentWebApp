...
<!DOCTYPE html>
    <html>
        <head>
            ...
            <link rel=stylesheet href='refrences/css/multipleplay.css'>
            ...
            <script src="refrences/js/multipleplay.js"></script>
            <script src='refrences/js/questionget.js'></script>
            <script src='refrences/js/playSockHandler.js'></script>
        </head>
        <body>
  ...
  <div class="demo__inner">
    <svg class="demo__numbers" viewBox="0 0 100 100">
      ...
      <path class="demo__numbers-path" 
            ...
            <section id='pausedisplay' style="display:none">
            ...
            <section class=container>
                <section class=hero>
                        ...
                        <div class='pause far fa-pause-circle' style="display:none"></div>
                        <div class='scorebox'><span class='text-score'>Score: &nbsp;&nbsp;<span><span id='score'></span></div>
                    <div class="top-bar">
                        <div class="disp-score" id="viewScoreboard" onclick="viewscore()">
                             View Scoreboard 
                              <div id="scoreDisp" >
                                     <div class="scores-cont">
                                      <ul id='scoreCorner'>
                                         <!-- <li class="a-score me">
                                             <span> 1 </span>
                                             <div class=profile-pic> </div>
                                             <span id="player-name"> Beemarsh bhusal</span>
                                             <span id="no-score"> 5000</span>
                                         </li>
                                         <li class="a-score">
                                             <span> 2 </span>
                                             <div class=profile-pic> </div>
                                             <span id="player-name"> prajwal adhikari</span>
                                             <span id="no-score"> 50</span>
                                         </li> -->
            ...
            <section class='results'>
                <span class="overall-score"> Final Scoreboard<!--, You socred <p id="final-score"> </p> --></span>
